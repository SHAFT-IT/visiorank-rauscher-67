...
;
    ...
    $total_pages = ceil($query->found_posts/$show);
     ...
     $page_links = paginate_links(array(  
            ...
            'mid_size'     => 1,
            'prev_next'    => true,
            'prev_text'    => __('&laquo; Previous','magazon'),
            'next_text'    => __('Next &raquo;','magazon'),
            'show_all' => false,
            'add_args'=>false
        ));
    ...
    echo '<div class="paginate">
        <div class="s">
             ...
             <p><label><input type="checkbox" value="1" '.$only_c.'class="pb-only-img-p"/>'.__('Uploaded for this page','magazon').'</label></p>
        </div>
        <div class="stp">
         '.$page_links.'
         </div>
   ...
   endwhile;
    ...
    echo '</div>';
     ...
     ?>
    <p class="tip"><?php _e('Click to item to add','magazon'); ?></p>
    <?php
  die();
}
