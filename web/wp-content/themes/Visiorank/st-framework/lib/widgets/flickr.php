...
/*-----------------------------------------------------------------------------------*/
     ...
     class STFlickrWidget extends WP_Widget {
         ...
         function widget($args, $instance) {
            ...
            if($title)
                echo $before_title;
               // _e('<span>flick<span class="r">r</span></span>','magazon'); 
         ...
         function form($instance) {
            ...
            <!-- Flickr ID -->
    		<p>
    			<label for="<?php echo $this->get_field_id( 'flickrID' ); ?>"><?php _e('Flickr ID:', 'magazon') ?> (<a href="http://idgettr.com/">idGettr</a>)</label>
    		...
    		<!-- Postcount -->
    		<p>
    			<label for="<?php echo $this->get_field_id( 'postcount' ); ?>"><?php _e('Number of Photos:', 'magazon') ?></label>
    		...
    		<!-- Display -->
    		<p>
    			<label for="<?php echo $this->get_field_id( 'display' ); ?>"><?php _e('Display (random or latest):', 'magazon') ?></label>
            ...
            <!-- Type -->
    		<p>
    			<label for="<?php echo $this->get_field_id( 'type' ); ?>"><?php _e('Type (user or group):', 'magazon') ?></label>
