...
class STRelatedPosts extends WP_Widget {

    public function __construct() {
        // widget actual processes
        parent::__construct(
            'strelatedposts', // Base ID
            'ST Related Posts', // Name
            array( 'description' => __( 'Display Related Posts', 'magazon' ), ) // Args
        );
    }
...
register_widget( 'STRelatedPosts' );