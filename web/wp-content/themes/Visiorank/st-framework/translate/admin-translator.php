...
if($_POST['save_change']!=''){
       ...
       // 
        ...
        update_option('_st_where_tran',$_POST['_st_where_tran']);
...
if(empty($ST_TRANSLATE_OPTION)){
    $ST_TRANSLATE_OPTION=  st_get_translate_default();
}

$_st_where_tran = get_option('_st_where_tran', array('b'=>'','f'=>'f'));
...
<div class="st-trans">
    ...
    <div class="stttabs-cont">
     ...
     <p class="btns">
        ...
        /*
         <p>
             <label><input type="checkbox" name="_st_where_tran[b]" value="b"  <?php echo $_st_where_tran['b']!='' ? ' checked="checked" ' :  ''; ?> /> Translate in backend</label>  &nbsp;&nbsp;&nbsp;&nbsp;
             <label><input type="checkbox" name="_st_where_tran[f]"  value="f" <?php echo $_st_where_tran['f']!='' ? ' checked="checked" ' :  ''; ?> /> Translate in frontend</label>
            &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        */ 
        ?>
        <p>
         <input type="submit" class="button button-primary button-large" name="save_change" value="Save change" /><br />
        </p>
        
        <input type="hidden" name="_st_where_tran[f]" value="f" />
